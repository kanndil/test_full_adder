...
set ::env(NETGEN_SETUP) /nc/apps/pdk/ciel/sky130/versions/0fe599b2afb6708d281543108caf8310912f54af/sky130A/libs.tech/netgen/sky130A_setup.tcl
set ::env(LVS_INCLUDE_MARCO_NETLISTS) 0
set ::env(CURRENT_SPICE) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/66-magic-spiceextraction/FullAdder.spice
set ::env(CURRENT_POWERED_NETLIST) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/51-openroad-fillinsertion/FullAdder.pnl.v
