set ::env(TRACKS_INFO_FILE_PROCESSED) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/13-openroad-floorplan/config.tracks
...
set ::env(CURRENT_NETLIST) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/06-yosys-synthesis/FullAdder.nl.v
set ::env(SAVE_ODB) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/13-openroad-floorplan/FullAdder.odb
set ::env(SAVE_DEF) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/13-openroad-floorplan/FullAdder.def
set ::env(SAVE_SDC) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/13-openroad-floorplan/FullAdder.sdc
set ::env(SAVE_NETLIST) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/13-openroad-floorplan/FullAdder.nl.v
set ::env(SAVE_POWERED_NETLIST) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/13-openroad-floorplan/FullAdder.pnl.v
