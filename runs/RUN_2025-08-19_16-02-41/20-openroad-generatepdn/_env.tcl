set ::env(FP_PDN_CFG) /nix/store/zs0jjs1cnaljzhp3rwp8bw7z27hk44md-python3-3.11.9-env/lib/python3.11/site-packages/librelane/scripts/openroad/common/pdn_cfg.tcl
...
set ::env(CURRENT_ODB) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/18-openroad-tapendcapinsertion/FullAdder.odb
set ::env(SAVE_ODB) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/20-openroad-generatepdn/FullAdder.odb
set ::env(SAVE_DEF) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/20-openroad-generatepdn/FullAdder.def
set ::env(SAVE_SDC) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/20-openroad-generatepdn/FullAdder.sdc
set ::env(SAVE_NETLIST) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/20-openroad-generatepdn/FullAdder.nl.v
set ::env(SAVE_POWERED_NETLIST) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/20-openroad-generatepdn/FullAdder.pnl.v
