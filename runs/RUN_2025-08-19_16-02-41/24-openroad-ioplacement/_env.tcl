...
set ::env(CURRENT_ODB) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/23-openroad-globalplacementskipio/FullAdder.odb
set ::env(SAVE_ODB) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/24-openroad-ioplacement/FullAdder.odb
set ::env(SAVE_DEF) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/24-openroad-ioplacement/FullAdder.def
set ::env(SAVE_SDC) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/24-openroad-ioplacement/FullAdder.sdc
set ::env(SAVE_NETLIST) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/24-openroad-ioplacement/FullAdder.nl.v
set ::env(SAVE_POWERED_NETLIST) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/24-openroad-ioplacement/FullAdder.pnl.v
