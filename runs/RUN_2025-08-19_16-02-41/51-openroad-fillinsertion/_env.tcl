...
set ::env(CURRENT_ODB) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/47-odb-reportdisconnectedpins/FullAdder.odb
set ::env(SAVE_ODB) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/51-openroad-fillinsertion/FullAdder.odb
set ::env(SAVE_DEF) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/51-openroad-fillinsertion/FullAdder.def
set ::env(SAVE_SDC) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/51-openroad-fillinsertion/FullAdder.sdc
set ::env(SAVE_NETLIST) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/51-openroad-fillinsertion/FullAdder.nl.v
set ::env(SAVE_POWERED_NETLIST) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/51-openroad-fillinsertion/FullAdder.pnl.v
