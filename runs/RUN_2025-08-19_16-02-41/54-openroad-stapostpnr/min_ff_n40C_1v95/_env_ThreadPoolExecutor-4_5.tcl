...
set ::env(CURRENT_NETLIST) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/51-openroad-fillinsertion/FullAdder.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/53-openroad-rcx/nom/FullAdder.nom.spef \"min_*\" /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/53-openroad-rcx/min/FullAdder.min.spef \"max_*\" /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/53-openroad-rcx/max/FullAdder.max.spef"
set ::env(CURRENT_ODB) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/52-odb-cellfrequencytables/FullAdder.odb
set ::env(SAVE_SDC) /workspace/test_full_adder/runs/RUN_2025-08-19_16-02-41/54-openroad-stapostpnr/FullAdder.sdc
